...
'use strict';
  ...
  angular
    ...
    /* @inject */
    function Organizations($http, serverUrl, $q, logger) {
      // Define Private Variables
      var api = createUrl(serverUrl, 'organizations');
      ...
      function create ( data ){
        return $http.post( api, data )
          .then( function (response){
            logger.logSuccess('Organizations Saved');
      ...
      function update ( id, data ){
        return $http.put( createUrl( api, id ), data )
          .then( function (response){
            logger.logSuccess('Organization Updated Successfully');
            return response.data;
          })
          .catch( function (err){
            logger.logError('Error Saving');
